...
from image_processor import compress_image, compress_lossless
    ...
    try:
        if mode == 'lossy':
            ...
            return render_template(
                ...
                ratio=round(ratio, 1),
                k=k,
                algorithm='K-Means Color Clustering',
                output_format='JPEG',
            )

        else:
            # ── LOSSLESS: smart format selection ────────────────────────
            result = compress_lossless(image_bytes, filename)
